                  ...
                  <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                      <td style="background-color: #ffffff; padding: 40px 30px; text-align: center;">
                        <h1 style="color: #111827; margin: 0; font-size: 28px; font-weight: 700; letter-spacing: -0.56px;">
                          제보 답변이 등록되었습니다
                        </h1>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding: 40px 30px;">
                        <p style="color: #374151; font-size: 16px; line-height: 1.45; letter-spacing: -0.08px; margin: 0 0 20px 0;">
                          지란지교패밀리 윤리경영 상담관리센터입니다.
                        </p>
                        <p style="color: #374151; font-size: 16px; line-height: 1.45; letter-spacing: -0.08px; margin: 0 0 30px 0;">
                          귀하께서 제보하신 내용에 대한 답변이 등록되었습니다.
                        </p>

                        <!-- Reply Box -->
                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; border-left: 4px solid #FF8A20; background-color: #ff8c200d; margin: 30px 0; border: 1px solid rgba(17, 24, 39, 0.1);">
                          <tr>
                            <td style="padding: 30px;">
                              <p style="color: #FF8A20; font-size: 18px; font-weight: 700; letter-spacing: -0.09px; margin: 0 0 15px 0;">
                                ${replyTitle}
                              </p>
                              <div style="color: #374151; font-size: 15px; line-height: 1.8; letter-spacing: -0.075px; white-space: pre-wrap;">
                                ${replyContent}
                              </div>
                            </td>
                          </tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                          <tr>
                            <td align="center">
                              <a href="https://cherish-jiran.vercel.app/sample/sample-check-form" style="display: inline-block; background-color: #111827; color: #ffffff; text-decoration: none; padding: 14px 40px; border-radius: 12px; font-size: 16px; font-weight: 700; letter-spacing: -0.08px;">
                                전체 내용 확인하기
                              </a>
                            </td>
                          </tr>
                        ...
                        <!-- Info Box -->
                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #e3f2fd; border-left: 4px solid #4A90E2; border-radius: 8px; margin: 30px 0;">
                          <tr>
                    ...
                    <tr>
                      <td style="background-color: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid rgba(17, 24, 39, 0.1);">
                        <p style="color: #9CA3AF; font-size: 13px; letter-spacing: -0.065px; margin: 0 0 10px 0;">
                          지란지교패밀리 윤리경영 상담관리센터
                        </p>
