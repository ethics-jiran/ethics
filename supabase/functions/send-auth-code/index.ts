                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding: 28px; text-align: center;">
                                        <p
                                            style="color: #6B7280; font-size: 14px; letter-spacing: -0.05px; margin: 0 0 10px 0;">
                                            인증 코드</p>
                                        <p
                                            style="color: #FF8A20; font-size: 28px; font-weight: 700; letter-spacing: 4px; margin: 0; font-family: monospace;">
                                            ${authCode}
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="https://cherish-jiran.vercel.app/sample/sample-check-form"
